...
/*
 * Controller recebe as requisições http na url /oportunidades 
 * e retornam os metodos criados
 * */
...
public class OportunidadeController {
	...
	public Oportunidade adicionar(@Valid @RequestBody Oportunidade oportunidade) {
		...
		if (oportunidadeExistente.isPresent()) {
			throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Já existe uma oportunidade para este prospecto"
